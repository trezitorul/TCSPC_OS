...
class QuTAG:
    ...
    def __init__(self):
        ...
        file_path="C:\\Users\\Ozymandias\\TCSPC_project\\QuTag\\quTAG_MC-Software_Python-examples-20220711 (1)\\quTAG_MC-Software_Python-examples-20220711\\DLL_64bit\\tdcbase.dll"
        ...
        # load DLL 
        self.qutools_dll = ctypes.windll.LoadLibrary( file_path )
